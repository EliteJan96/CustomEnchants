...
public class RegenSteakConsumeListener0 implements Listener {

	@EventHandler(priority = EventPriority.HIGH, ignoreCancelled = true)
	public void onPlayerItemConsume(PlayerItemConsumeEvent e) {
		
		int seconds = Main.config.getInt("RegenFood.I.seconds");
		int amplifier = Main.config.getInt("RegenFood.I.amplifier");
		...
		if (player instanceof Player) {
			...
			if (foodim.hasLore()) {
				...
				if (foodim.getLore().contains("§r§7RegenFood I")) {
